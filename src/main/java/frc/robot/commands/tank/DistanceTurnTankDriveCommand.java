...
public class DistanceTurnTankDriveCommand extends CommandBase {
  ...
  public DistanceTurnTankDriveCommand(TankDriveSubsystem subsystem, DoubleSupplier distance, DoubleSupplier speed) {
